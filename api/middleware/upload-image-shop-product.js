...
const uploadImageShopProduct = multer({
  storage: multerS3({
    s3: s3,
    ...
    key: async (req, file, cb) => {
      ...
      cb(null, `${process.env.SHOP_BUCKET_PRODUCT_IMAGES_FOLDER}/${sha1}${path.extname(file.originalname)}`)
    },
    limits: {
...
export default uploadImageShopProduct
