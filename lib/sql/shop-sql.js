...
const getProductImageList = (addresses) => {
  return new Promise(async (resolve, reject) => {
    const sql = `
    SELECT 
      shop_images.address, shop_images.orig_name, shop_images.stored_name, shop_images.location  
    FROM shop_images 
 ...
 */
const deleteShopImage = (address) => {
  return new Promise(async (resolve, reject) => {
    const sql = `DELETE FROM shop_images WHERE shop_images.address = '${address}';`
    try {
 ...
 * @return {Promise} Number of affected rows
 */
const deleteProductFile = (address) => {
  return new Promise(async (resolve, reject) => {
    const sql = `DELETE FROM shop_files WHERE shop_files.address = '${address}';`
    try {
      const resultObj = await dbDelete(sql)
      if (resultObj.error === null) {
        resolve(resultObj.affectedRows)
 ...
 * @param {string} groupDesc Group description
 * @return {Promise}
 */
const updateShopGroup = (groupAddress, imgAddress, groupName, groupDesc) => {
  return new Promise(async (resolve, reject) => {
    const sql = `
      UPDATE shop_products_groups 
      SET 
        group_name = '${groupName}', 
        group_description = '${groupDesc}', 
        group_image_address = '${imgAddress}'  
      WHERE 
  ...
  return new Promise(async (resolve, reject) => {
    const sql = `
      ...
      SET 
        ...
        product_image_addresses = '${productImages}', 
        product_dispatch_time = '${productDispatchTime}', 
        ...
        product_group_addresses = '${productGroups}', 
        product_file_address = ${!productFile ? null : "'"+productFile+"'"} 
      WHERE 
